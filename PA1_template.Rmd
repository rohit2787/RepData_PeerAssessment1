...
Based on the two plots (with NA values ignored and imputed), there appears to be marginal difference between the mean and median values. The mean of the total steps taken per day remains the same. While the median shows a marginal increase and becomes equal to the mean value.
